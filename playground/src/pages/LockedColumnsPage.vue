...
<template>
    <section class="space-y-3">
        <h2 class="text-xl font-semibold">Pinned/Locked Columns (pt-BR)</h2>

        <PantanalGrid :rows="rows" :columns="columns as any" key-field="id" v-model:sort="sort" v-model:filter="filter"
            v-model:page="page" v-model:pageSize="pageSize" :enable-column-resize="true" :enable-column-reorder="true"
            :show-filter-row="true" responsive="table" :pinned-shadows="true" :striped="true" :height="420" />

        <p class="text-sm text-slate-600">
            Dica: role horizontalmente para ver as colunas não fixas.
            <b>ID</b> e <b>Nome</b> estão “pinned” à esquerda; <b>Status</b> e <b>Score</b> à direita.
            Redimensione as colunas pelo grip na borda do cabeçalho.
        </p>
    </section>
</template>
